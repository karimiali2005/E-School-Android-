...
public class ConvertChatmessageToRoomChatShowLeftResualt {
    ...
    RoomChatLeftShowResult rcl2=new RoomChatLeftShowResult();

    public ConvertChatmessageToRoomChatShowLeftResualt(ChatMessage chatMessage, RoomChatLeftShowResult roomChatLeftShowResult) {
